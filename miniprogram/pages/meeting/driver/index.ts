...
Page({
  ...
  data: {
    formItem: [
      ...
      { label: '车型',  name: 'vehicleModel', value: '', type: 'input', required: { message: '请输入车型' } },
      { label: '车辆颜色',  name: 'vehicleColor', value: '', type: 'input', required: { message: '请输入车辆颜色' } },
      { label: '车牌号',  name: 'plateNumber', value: '', type: 'input', required: { message: '请输入车牌号' } },
